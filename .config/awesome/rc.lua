...
beautiful.master_width_factor = "0.666666"
...
globalkeys = gears.table.join(
 ...
 awful.key({},"XF86MonBrightnessUp", function () awful.spawn("xbacklight -inc 10") end, {description = "brightness up", group = "screen"}),
 awful.key({},"XF86MonBrightnessDown", function () awful.spawn("xbacklight -dec 10") end, {description = "brightness down", group = "screen"}),
 ...
 -- custom launchers
 awful.key({ modkey, }, "n", function () awful.spawn("kitty nvim -c VimwikiIndex") end, {description = "open Vimwiki", group = "launcher"}),
 ...
 awful.key({ modkey, }, "w", function () awful.spawn(browser) end, {description = "open browser", group = "launcher"}),
 awful.key({ modkey, }, "e", function () awful.spawn(filemanager) end, {description = "open filemanager", group = "launcher"}),
 awful.key({ modkey, }, "d", function () awful.spawn("discord") end, {description = "open discord", group = "launcher"}),
 awful.key({},"XF86Calculator", function () awful.spawn("gnome-calculator") end, {description = "open calculator", group = "launcher"}),
 awful.key({},"Print"         , function () awful.spawn("flameshot gui") end, {description = "open gscreenshot", group = "launcher"}),
 --awful.key({ modkey, }, "", function () awful.spawn("") end, {description = "", group = "launcher"}),
...
clientkeys = gears.table.join(
 ...
 awful.key({ modkey, }, "f", function (c) c.maximized_horizontal = false c.maximized_vertical = false c.maximized = not c.maximized c:raise() end , {description = "(un)maximize", group = "client"}),
